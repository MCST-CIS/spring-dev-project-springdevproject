...
function preload() {
  ...
  bgImg = loadImage("background-levelone.png");
  fgImg = loadImage("foreground-level1.png");
  p1Img = loadImage("player1.png");
  p2Img = loadImage("player2.png");
  enemyImg = loadImage("enemiegoop.png");
  
  // GIFs load easily in standard p5.js as well
  p1Attack = loadImage("paintattackleft.gif");
  p2Attack = loadImage("riffattackleft.gif");
}
